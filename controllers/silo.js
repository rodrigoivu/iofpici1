...
const actualizaItem = async( req, res = response ) => {
    ...
    try {
        ...
        const itemFound = await Silo.findById( itemId );
        ...
        const item = await Silo.findByIdAndUpdate( itemId, params, { new: true });
...
const deleteItem = async( req, res = response ) => {
    ...
    try {
        ...
        const item = await Silo.findById( itemId );
        ...
        await Silo.findByIdAndDelete( itemId );
