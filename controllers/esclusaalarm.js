...
const Esclusaalarm = require('../models/Esclusaalarm');
...
const registraItem = async( req, res = response ) => {
    ...
    const item = new Esclusaalarm( req.body );
...
const itemsRangoFechas = async( req, res = response ) => {
    ...
    try {
		...
		const items = await Esclusaalarm.find({
											'esclusa': itemId,
											ts : {
...
const itemsRangoUltimos = async( req, res = response ) => {
    ...
    try {
		...
		const items = await Esclusaalarm.find({ 'esclusa': itemId })
										.skip(0)
										.limit(nitems)
                            			.sort([['ts', -1]]);
...
const deleteItem = async( req, res = response ) => {
    ...
    try {
        ...
        const item = await Esclusaalarm.findById( itemId );
        ...
        await Esclusaalarm.findByIdAndDelete( itemId );
