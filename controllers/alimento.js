...
const registraItem = async( req, res = response ) => {
    ...
    const item = new Alimento( req.body );
...
const actualizaItem = async( req, res = response ) => {
    ...
    try {
        ...
        const itemFound = await Alimento.findById( itemId );
        ...
        const item = await Alimento.findByIdAndUpdate( itemId, params, { new: true });
...
const deleteItem = async( req, res = response ) => {
    ...
    try {
        ...
        const item = await Alimento.findById( itemId );
        ...
        await Alimento.findByIdAndDelete( itemId );
